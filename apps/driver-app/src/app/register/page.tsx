...
export default function DriverRegisterPage() {
  ...
  const [driver, setDriver] = useState({
    phoneNumber: "",
    email: "",
    vehicleType: "MOTORBIKE" as string,
  ...
  async function createDriver(e: React.FormEvent) {
    ...
    try {
      await (driverApi as any).register({
        ...
        email: driver.email || account.email,
      ...
      setError(
        err instanceof Error ? err.message : "Tạo hồ sơ tài xế thất bại",
      );
    } finally {
      setLoading(false);
    }
            ...
            <form onSubmit={createAccount} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border px-4 py-3 text-sm focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none"
                  required
                />
              </div>
              <div>
            ...
            <form onSubmit={createDriver} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setDriver({ ...driver, vehicleType: e.target.value })
                  }
                  className="w-full rounded-lg border px-4 py-3 text-sm focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDriver({ ...driver, idCardNumber: e.target.value })
                  }
                  placeholder="079201234567"
                  className="w-full rounded-lg border px-4 py-3 text-sm focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  value={driver.insuranceNumber}
                  onChange={(e) =>
                    setDriver({ ...driver, insuranceNumber: e.target.value })
                  }
                  placeholder="INS-2024-98765"
                  className="w-full rounded-lg border px-4 py-3 text-sm focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none"
                  required
                />
              </div>
        ...
        {step === "done" && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 mb-4">
              Hồ sơ tài xế của bạn đang chờ Admin duyệt.
            </p>
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6 text-sm text-yellow-800">
              <p className="font-medium mb-1">⏳ Trạng thái: INACTIVE</p>
              <p>
                Admin sẽ duyệt hồ sơ của bạn trong vòng 24-48h. Bạn có thể đăng
                nhập để theo dõi trạng thái.
              </p>
            </div>
            <button
